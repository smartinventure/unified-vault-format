...
namespace UvfLib.VaultHelpers
{
    ...
    public class CryptomatorVault : IDisposable
    {
        ...
        private void LoadVault()
        {
            ...
            _vault = Vault.LoadCryptomatorV8Vault(masterkeyBytes, _password);
        }
        ...
        private (DirectoryMetadata directoryMetadata, string physicalPath) ResolvePathToDirectory(string path)
        {
            EnsureVaultLoaded();
        ...
        private static long CalculateDecryptedFileSize(long encryptedSize)
        {
            ...
            return Vault.CalculateExpectedDecryptedSize(encryptedSize);
        }
