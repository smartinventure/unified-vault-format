...
using UvfLib.Core.Api; // For Masterkey interface, now explicitly used below
using UvfLib.Core.Common; // For DestroyableSecretKey and CryptographicOperations
...
namespace UvfLib.Core.Common
{
    ...
    /// </summary>
    public sealed class PerpetualMasterkey : UvfLib.Core.Api.DestroyableMasterkey // Implement DestroyableMasterkey
    {
