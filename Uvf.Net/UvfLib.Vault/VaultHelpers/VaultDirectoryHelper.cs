...
namespace UvfLib.Vault.VaultHelpers
{
    ...
    internal static class VaultDirectoryHelper
    {
        ...
        public static byte[] EncryptDirectoryMetadataInternal(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata metadata)
        {
        ...
        public static UvfLib.Core.Api.DirectoryMetadata CreateNewDirectoryMetadataInternal(Cryptor cryptor)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
        ...
        public static string EncryptFilenameInternal(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata directoryMetadata, string plaintextFilename)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
        ...
        public static string DecryptFilenameInternal(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata directoryMetadata, string encryptedFilename)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
            if (directoryMetadata == null) throw new ArgumentNullException(nameof(directoryMetadata));
        ...
        public static string GetDirectoryPathInternal(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata directoryMetadata)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
            if (directoryMetadata == null) throw new ArgumentNullException(nameof(directoryMetadata));
        ...
        public static string GetDirectoryMetadataFilename(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata directoryMetadata = null)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
            ...
            if (cryptor.DirectoryContentCryptor().GetType().FullName?.Contains("CryptomatorV8") == true)
            {
                ...
                if (directoryMetadata != null)
                {
                    ...
                    if (directoryMetadata.Equals(coreRootMetadata))
                    {
        ...
        public static bool ShouldSaveDirectoryMetadata(Cryptor cryptor, UvfLib.Core.Api.DirectoryMetadata directoryMetadata)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
            if (directoryMetadata == null) throw new ArgumentNullException(nameof(directoryMetadata));
        ...
        public static bool DirectoryMetadataExists(Cryptor cryptor, string directoryPath, UvfLib.Core.Api.DirectoryMetadata directoryMetadata)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
        ...
        public static bool DirectoryExists(Cryptor cryptor, string vaultBasePath, string plaintextDirectoryPath)
        {
            ...
            try
            {
                ...
                var currentDirMetadata = cryptor.DirectoryContentCryptor().RootDirectoryMetadata();
        ...
        public static (UvfLib.Core.Api.DirectoryMetadata metadata, string physicalPath)? TraverseToDirectory(Cryptor cryptor, string vaultBasePath, string plaintextDirectoryPath)
        {
            if (cryptor?.DirectoryContentCryptor() == null) throw new InvalidOperationException("Directory cryptor not available.");
            if (string.IsNullOrEmpty(vaultBasePath)) throw new ArgumentException("Vault base path cannot be null or empty", nameof(vaultBasePath));
            if (string.IsNullOrEmpty(plaintextDirectoryPath)) throw new ArgumentException("Directory path cannot be null or empty", nameof(plaintextDirectoryPath));
