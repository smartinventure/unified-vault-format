...
namespace UvfLib.CryptomatorV8
{
    ...
    /// </summary>
    internal class FileHeaderImpl : FileHeader, IDisposable
    {
        ...
        internal FileHeaderImpl(byte[] nonce, Payload payload)
        {
        ...
        public class Payload : IDisposable
        {
            ...
            internal Payload(long reserved, byte[] contentKeyBytes)
            {
            ...
            internal long GetReserved() => _reserved;

            /// <summary>
            /// Sets the reserved field value.
            /// </summary>
            /// <param name="reserved">The reserved value</param>
            internal void SetReserved(long reserved) => _reserved = reserved;
